define("UsrRealtyClassic1Page", ["ServiceHelper"], function(ServiceHelper) {
	return {
		...
		diff: /**SCHEMA_DIFF*/[
			{
				"operation": "insert",
				"name": "UsrName9d58e10c-06e8-4532-883c-8b3790522d83",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "FLOAT53fd7410-a507-41a5-b23b-73d9285db1f3",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "FLOAT3799bf05-66d7-4cb1-8523-44ebf1bf0b48",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "LOOKUPb404e09f-2dfa-404b-8e3b-64f09f6e2393",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "LOOKUP89a34935-d128-4df6-bd36-132b005f70b3",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "STRING80d664c8-12a1-4dbc-a56c-5373b78901d7",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "LOOKUPe116de02-e41a-40d5-a9db-3eadde96e9d7",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
